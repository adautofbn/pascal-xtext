 ...
 * <ul>
 *   <li>{@link edu.ufcg.compiladores.pascal.pascal.impl.blockImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class blockImpl extends MinimalEObjectImpl.Container implements block
{
  ...
  public EList<statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<statement>(statement.class, this, PascalPackage.BLOCK__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PascalPackage.BLOCK__STATEMENTS:
