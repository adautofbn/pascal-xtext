...
public class InternalPascalLexer extends Lexer {
    ...
    public final void mT__19() throws RecognitionException {
        try {
            int _type = T__19;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:16:7: ( 'div' )
            // InternalPascal.g:16:9: 'div'
            {
            match("div"); 
    ...
    public final void mT__20() throws RecognitionException {
        try {
            int _type = T__20;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:17:7: ( 'mod' )
            // InternalPascal.g:17:9: 'mod'
            {
            match("mod"); 
    ...
    public final void mT__25() throws RecognitionException {
        try {
            int _type = T__25;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:22:7: ( 'boolean' )
            // InternalPascal.g:22:9: 'boolean'
            {
            match("boolean"); 
    ...
    public final void mT__26() throws RecognitionException {
        try {
            int _type = T__26;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:23:7: ( 'integer' )
            // InternalPascal.g:23:9: 'integer'
            {
            match("integer"); 
    ...
    public final void mT__27() throws RecognitionException {
        try {
            int _type = T__27;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:24:7: ( 'string' )
            // InternalPascal.g:24:9: 'string'
            {
            match("string"); 
    ...
    public final void mT__28() throws RecognitionException {
        try {
            int _type = T__28;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:25:7: ( 'program' )
            // InternalPascal.g:25:9: 'program'
            {
            match("program"); 
    ...
    public final void mT__34() throws RecognitionException {
        try {
            int _type = T__34;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:31:7: ( 'begin' )
            // InternalPascal.g:31:9: 'begin'
            {
            match("begin"); 
    ...
    public final void mT__35() throws RecognitionException {
        try {
            int _type = T__35;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:32:7: ( 'end' )
            // InternalPascal.g:32:9: 'end'
            {
            match("end"); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:2152:13: ( '\\'' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '^' | '?' | '.' | '/' | '\\\\' | '*' | '%' | '&' | '@' | '#' | '(' | ')' | '$' | '=' | '{' | '}' | '[' | ']' | ',' | '!' | '|' | '+' | '-' )* '\\'' )
            // InternalPascal.g:2152:15: '\\'' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '^' | '?' | '.' | '/' | '\\\\' | '*' | '%' | '&' | '@' | '#' | '(' | ')' | '$' | '=' | '{' | '}' | '[' | ']' | ',' | '!' | '|' | '+' | '-' )* '\\''
            {
            match('\''); 
            // InternalPascal.g:2152:20: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '^' | '?' | '.' | '/' | '\\\\' | '*' | '%' | '&' | '@' | '#' | '(' | ')' | '$' | '=' | '{' | '}' | '[' | ']' | ',' | '!' | '|' | '+' | '-' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:2154:14: ( ( 'true' | 'false' ) )
            // InternalPascal.g:2154:16: ( 'true' | 'false' )
            {
            // InternalPascal.g:2154:16: ( 'true' | 'false' )
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalPascal.g:2154:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_MULTI_LINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:2156:25: ( ( '{*' ( options {greedy=false; } : . )* '*}' | '(*' ( options {greedy=false; } : . )* '*)' ) )
            // InternalPascal.g:2156:27: ( '{*' ( options {greedy=false; } : . )* '*}' | '(*' ( options {greedy=false; } : . )* '*)' )
            {
            // InternalPascal.g:2156:27: ( '{*' ( options {greedy=false; } : . )* '*}' | '(*' ( options {greedy=false; } : . )* '*)' )
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // InternalPascal.g:2156:28: '{*' ( options {greedy=false; } : . )* '*}'
                    {
                    match("{*"); 

                    // InternalPascal.g:2156:33: ( options {greedy=false; } : . )*
                    loop3:
                    do {
                        int alt3=2;
                    ...
                    break;
                case 2 :
                    // InternalPascal.g:2156:70: '(*' ( options {greedy=false; } : . )* '*)'
                    {
                    match("(*"); 

                    // InternalPascal.g:2156:75: ( options {greedy=false; } : . )*
                    loop4:
                    do {
                        int alt4=2;
    ...
    public final void mRULE_SINGLE_LINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:2158:26: ( '{' (~ ( ( '\\n' | '\\r' ) ) )* '}' ( ( '\\r' )? '\\n' )? )
            // InternalPascal.g:2158:28: '{' (~ ( ( '\\n' | '\\r' ) ) )* '}' ( ( '\\r' )? '\\n' )?
            {
            match('{'); 
            // InternalPascal.g:2158:32: (~ ( ( '\\n' | '\\r' ) ) )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:2160:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalPascal.g:2160:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalPascal.g:2160:11: ( '^' )?
            int alt9=2;
            ...
            // InternalPascal.g:2160:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:2162:10: ( ( '0' .. '9' )+ )
            // InternalPascal.g:2162:12: ( '0' .. '9' )+
            {
            // InternalPascal.g:2162:12: ( '0' .. '9' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:2164:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalPascal.g:2164:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalPascal.g:2164:24: ( options {greedy=false; } : . )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:2166:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalPascal.g:2166:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalPascal.g:2166:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop13:
            do {
                int alt13=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:2168:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalPascal.g:2168:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalPascal.g:2168:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt16=0;
            loop16:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:2170:16: ( . )
            // InternalPascal.g:2170:18: .
            {
            matchAny(); 
    ...
    static final String DFA17_eotS =
        "\1\uffff\1\40\4\uffff\2\46\1\51\1\53\4\46\1\uffff\1\46\1\64\2\uffff\1\46\1\uffff\1\36\2\46\2\36\2\uffff\1\36\10\uffff\1\46\1\uffff\1\46\4\uffff\5\46\1\uffff\1\46\4\uffff\1\46\2\uffff\2\46\6\uffff\1\120\1\121\5\46\1\127\1\130\2\46\1\uffff\1\75\3\uffff\5\46\2\uffff\1\143\1\46\1\37\1\uffff\1\75\1\46\1\146\3\46\1\uffff\1\143\1\46\1\uffff\1\46\1\154\1\46\1\156\1\157\1\uffff\1\160\3\uffff";
    static final String DFA17_eofS =
        "\161\uffff";
    static final String DFA17_minS =
        "\1\0\1\52\4\uffff\1\151\1\157\2\75\1\145\1\156\1\164\1\162\1\uffff\1\141\1\75\2\uffff\1\156\1\uffff\1\41\1\162\1\141\1\0\1\101\2\uffff\1\52\10\uffff\1\166\1\uffff\1\144\4\uffff\1\157\1\147\1\164\1\162\1\157\1\uffff\1\162\4\uffff\1\144\2\uffff\1\165\1\154\1\0\5\uffff\2\60\1\154\1\151\1\145\1\151\1\147\2\60\1\145\1\163\3\0\2\uffff\1\145\1\156\1\147\1\156\1\162\2\uffff\1\60\1\145\3\0\1\141\1\60\1\145\1\147\1\141\1\uffff\1\60\1\156\1\uffff\1\162\1\60\1\155\2\60\1\uffff\1\60\3\uffff";
